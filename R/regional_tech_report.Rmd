...
Data_inv(params$set_file_ab, params$set_WB_names)
```
...
*Figure 5: Summary satatistics for `r params$set_region` `r params$set_WB_names` Areas.*
...
*Figure 7: Bivariate map comparing habitat suitability (% preferred Habitat) and potential dam density (The estimated density of dams at population capacity) for `r params$set_WB_names` areas.*
