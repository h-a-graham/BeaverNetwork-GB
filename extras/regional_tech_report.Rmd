---
title: "OpenBeaverNetwork and Beaver Habitat Index (South West)"
subtitle: "Data summary report"
author: "Hugh Graham, Alan Puttock, Richard Brazier"
output:
...
-   The Centre for Ecology and Hydrology (CEH) 2019 land cover map (LCM) [@morton2020] . This provides landcover classification at a resolution of 20m, derived from Sentinel 2 data using a random forest method. This dataset has been updated from the 2015 landcover map, used in our previous modelling work (Graham, et al. (2020).
...
*Figure 1: Beaver Habitat Index (BHI). Ranges from 0-5...*

The BHI has a resolution of 10 m. Therefore at this large scale, as shown in Figure 1, it can be hard to interpret. Therefore we also provide the BHI at a resampled resolution of 1km (Figure2). This aids interpretation at the regional/national scale.
...
*Tale 2: BDC calssifications and definitions*
...
*Table 3: Description of variables provided with the county summary polygon file*
...
## County Scale summary statistics

A range of summary statistics were calculated by carrying out a spatial join between the BeaverNetwork features and the county polygons. A range of summary statistics, desribed in Table 4, were derived to provide regional understanding. A selction of these summary stats are presented as a facet plot in Figure 4 and as a bivariate choropleth map in figure 5.
...
*Figure 4: Summary satatistics for South West Counties. This figures serves as an example for the types of satistics that can be derived for regions.*

Figure 5 serves as an example on how this data may be used to select or prioritise different regions for beaver reintroduction or management based on the interaction of multiple factors. In this example we compare the estimate dam density (under carrying capacity) with the proportion of the river network with preferred forage (within 40m of the bank). Here we can make inferences on how landuse and topographic differences in regions can influence the potential imapct of beavers.
...
*Figure 5: Bivariate map comparing habitat suitability (% preferred Habitat) and potential dam density (The estimated density of dams at population capacity)*
